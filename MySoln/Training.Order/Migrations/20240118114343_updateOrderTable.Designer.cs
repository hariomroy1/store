...
namespace Training.Order.Migrations
{
    ...
    [Migration("20240118114343_updateOrderTable")]
            ...
            modelBuilder.Entity("Training.Cart.Model.OrderEntity", b =>
                {
                    ...
                    b.Property<int?>("RegisterEntityRegisterId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegisterEntityRegisterId");
            ...
            modelBuilder.Entity("Training.Cart.Model.OrderEntity", b =>
                {
                    ...
                    b.HasOne("Training.Cart.Model.RegisterEntity", null)
                        .WithMany("Orders")
                        .HasForeignKey("RegisterEntityRegisterId");
                });
